...
router.route("/add").post(upload.single("image"), async (req, res) => {
  try {
    ...
    const confirmpaticipation = req.body.confirmpaticipation;
    const dateparticipation = req.body.dateparticipation;
    const accommodation = req.body.accommodation;
    const accommodationdate = req.body.accommodationdate;
    const attendweight = req.body.attendweight;
    const role = req.body.role;
    const letter = req.body.letter;
    const letteryes = req.body.letteryes;
